...
public class TheaterAPI {
    ...
    public static void getTheaterDetails(int userID) throws Exception{
        String q = "Select TheaterID,TheaterName,location from Theater  where userID = "+userID+"";;
    ...
    private static void addTheaterEntry(String t_name, String location, int uId) throws Exception{
        String query = "insert into Theater(TheaterName,Location,userID) values('"+t_name+"','"+location+"',"+uId+")";
        ConnectionUtil.insertQuery(query);
    }
    public static void addTheaters(int uId) throws Exception, InvalidException {
        ...
        addTheaterEntry(theaterName,location,uId);
